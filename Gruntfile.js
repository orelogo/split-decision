    ...
    babel: {
      ...
      dist: {
        files: [
          ...
          {expand: true, cwd: 'src/routes/', src: ['*.js'], dest: 'build/routes/'},
          {expand: true, cwd: 'src/models/', src: ['*.js'], dest: 'build/models/'},
          {expand: true, cwd: 'src/tests/', src: ['*.js'], dest: 'build/tests/'}
        ]
      }
    },
